...
<body class="vertical-layout" data-color="bg-gradient-x-purple-blue" style="background-color:black" onload="ccgen();">
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-body text-center anime">
                                ...
                                <span> </span>
                                <span> </span>
                                <h4 class="mb-2"><strong>undefy checker</strong></h4>
  ...
  <select name="gate" id="gate" class="form-control" style="margin-bottom: 5px;" id="gate" placeholder="Select Gate">
     ...
     <option style="background:rgba(16, 15, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/usd10ccn.php">CCN CHARGE 10$</option>
           <option style="background:rgba(16, 15, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/usd1ccn.php">CCN CHARGE 2$</option>
	  <option style="background:rgba(16, 15, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/eur1ccn.php">CCN CHARGE 1.2$</option>
	  <option style="background:rgba(16, 15, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/eur10ccn.php">CCN CHARGE 10€</option>
