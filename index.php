		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-body text-center">
					...
					<textarea rows="1" class="form-control text-center" style="width: 60%; float: left ;"  id="sec" placeholder="sk_live_xxxxxx"></textarea>
...
if(total > 20001){
  Swal.fire({title: 'YOU CAN NOT PERFORM THAT ACTION: REDUCE NUMBER OF CARDS TO <19999', icon: 'warning', showConfirmButton: false, toast: true, position: 'top-end', timer: 3000});
  return false;
}
...
var callBack = $.ajax({
url: gate + '?lista=' + data + '&sec=' + sec +'&tgm='+ tgm +'&cst=' + cst,
